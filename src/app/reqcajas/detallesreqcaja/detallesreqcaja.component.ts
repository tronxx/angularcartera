...
@Component({
  selector: 'app-detallesreqcaja',
  templateUrl: './detallesreqcaja.component.html',
  styleUrls: ['./detallesreqcaja.component.css']
})
export class DetallesreqcajaComponent implements OnInit {
  relcob? : Relcob;
  ...
  imprimir_relcob() {
    ...
    this.relcobservice.imprimir_req_caja(JSON.stringify(params_z));
